...
def main():
    ...
    df_ready_c10 = df_merged_c10.copy()  # cold 10% pellet-sand
    start_t10 = df_ready_c10.index.min()
    cutoff_t10 = start_t10 + pd.Timedelta(minutes=30)
    df_trimmed_c10 = df_ready_c10[df_ready_c10.index >= cutoff_t10]
    df_ready_h10 = df_merged_h10.copy()  # hot 10% pellet-sand
    ...
    df_ready_c100 = df_merged_c100.copy()  # cold 100% pellet-sand
    start_t100 = df_ready_c100.index.min()
    cutoff_t100 = start_t100 + pd.Timedelta(minutes=40)
    df_trimmed_c100 = df_ready_c100[df_ready_c100.index >= cutoff_t100]
    df_ready_h100 = df_merged_h100.copy()  # hot 100% pellet-sand
