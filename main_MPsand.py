...
in one single plot, for the four different scenarios (microplastic and sand,
microplastic and water, nurdles and sand, nurdles and water).
...
# FIRST: do this for MP-sand experiments***
def main():
    # Get filepaths
    ...
    df_cold, df_hot = plot1to1_multiple(df_merged_dict, text_str)  # not sure if I need ** before dict or not...
    '''
