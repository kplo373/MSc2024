# -*- coding: utf-8 -*-
"""
Created on Wed Oct  9 11:05:25 2024

Main script to run all the percentages for the Pellets (Nurdles)-Water
experiments.
...
def main():
    ...
    pathCSh5, pathOph5 = get_filepaths('22/08/2024', 'AM')  # hot 5% pellet-water
    
    pathCSc10, pathOpc10 = get_filepaths('02/09/2024', 'PM')  # cold 10% pellet-water
    pathCSh10, pathOph10 = get_filepaths('03/09/2024', 'AM')  # hot 10% pellet-water
    
    pathCSc25, pathOpc25 = get_filepaths('07/08/2024', 'PM')  # cold 25% pellet-water
    pathCSh25, pathOph25 = get_filepaths('09/08/2024', 'AM')  # hot 25% pellet-water    
    
    pathCSc50, pathOpc50 = get_filepaths('23/07/2024', 'AM')  # cold 50% pellet-water experiment
    pathCSh50, pathOph50 = get_filepaths('19/07/2024', 'AM')  # hot 50% pellet-water experiment
    
    pathCSc100, pathOpc100 = get_filepaths('29/07/2024', 'PM')  # cold 100% pellet-water experiment (pure pellets and 0 water)
    pathCSh100, pathOph100 = get_filepaths('25/07/2024', 'PM')  # hot 100% pellet-water (pure pellets)
    ...
    dt_CSc0, temps_arrCSc0, stdevs_arrCSc0 = read_CampbellSci(pathCSc0)  # cold 0% pellet-water mixture (pure water) thermocouple data
    df_water_avgCSc0 = water_avgCS(dt_CSc0, temps_arrCSc0, stdevs_arrCSc0)  # and getting the averages in a dataframe for the cold 0% pellet-water
    dt_CSh0, temps_arrCSh0, stdevs_arrCSh0 = read_CampbellSci(pathCSh0)  # hot 0% pellet-water thermocouple data
    df_water_avgCSh0 = water_avgCS(dt_CSh0, temps_arrCSh0, stdevs_arrCSh0)  # and averaging hot 0% pellet-water
    
    dt_CSc5, temps_arrCSc5, stdevs_arrCSc5 = read_CampbellSci(pathCSc5)  # continuing as above, with cold 5% pellet-water thermocouple data...
    ...
    dt_Opc0, a1c0, a2c0, a3c0, a4c0 = read_Optris(pathOpc0)  # cold 0% pellet-water Optris data (pure water)
    ...
    dt_Oph0, a1h0, a2h0, a3h0, a4h0 = read_Optris(pathOph0)  # hot 0% pellet-water Optris data (pure water)
    ...
    dt_Opc5, a1c5, a2c5, a3c5, a4c5 = read_Optris(pathOpc5)  # cold 5% pellet-water Optris data
    ...
    dt_Oph5, a1h5, a2h5, a3h5, a4h5 = read_Optris(pathOph5)  # hot 5% pellet-water Optris data
    ...
    dt_Opc10, a1c10, a2c10, a3c10, a4c10 = read_Optris(pathOpc10)  # cold 10% pellet-water Optris data 
    ...
    dt_Oph10, a1h10, a2h10, a3h10, a4h10 = read_Optris(pathOph10)  # hot 10% pellet-water Optris data
    ...
    dt_Opc25, a1c25, a2c25, a3c25, a4c25 = read_Optris(pathOpc25)  # cold 25% pellet-water Optris data
    ...
    dt_Oph25, a1h25, a2h25, a3h25, a4h25 = read_Optris(pathOph25)  # hot 25% pellet-water Optris data
    ...
    dt_Opc50, a1c50, a2c50, a3c50, a4c50 = read_Optris(pathOpc50)  # cold 50% pellet-water Optris data
    ...
    dt_Oph50, a1h50, a2h50, a3h50, a4h50 = read_Optris(pathOph50)  # hot 50% pellet-water Optris data
    ...
    dt_Opc100, a1c100, a2c100, a3c100, a4c100 = read_Optris(pathOpc100)  # cold 100% pellet-water Optris data (pure pellets)
    ...
    dt_Oph100, a1h100, a2h100, a3h100, a4h100 = read_Optris(pathOph100)  # hot 100% pellet-water Optris data
    ...
    cutoff_th5 = start_th5 + pd.Timedelta(minutes=30)
    ...
    cutoff_th25 = start_th25 + pd.Timedelta(minutes=30)
